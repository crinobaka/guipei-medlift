...
> ⚠️ **Original Work Declaration**: This project was independently developed by Zhang Hongxian. All code and features are original.
> **Reprint Notice**: Please credit with the source link: https://github.com/liuguangyihuanchang/guipei-medlift
> Unauthorized commercial use of this project's content is prohibited.
> ---

## What's New in v2.0.0

v2.0.0 is a complete architectural rebuild — more powerful, more stable, and better aligned with real clinical workflows.

**New Features**
- Voice recording + speech-to-text → AI auto-generates full medical records
- Image recognition → snap lab reports and AI reads them automatically
- Prompt editor → customize the AI generation template on the fly
- Auto progress-note generation → full daily notes from structured inputs
- Bluetooth TXT transfer support → safe for hospital internal networks (no external data transmission)

**Improvements**
- Complete app architecture refactor — cleaner, faster
- Fixed freezing and crash-on-launch issues
- Removed redundant features that added complexity without value
- Optimized for real residency training workflows
...
> 🔐 **患者隐私保护提醒**:上传检验/检查照片给 AI 时,请务必先**去除照片中的患者个人信息**(姓名、身份证号、联系方式等),避免患者隐私泄露。所有 AI 生成内容在正式提交前须经主治医师审核确认。
